...
{
    public GameObject mushRoomPreferb1, mushRoomPreferb2, smallMashroomPreferb, coinPreferb,shopPreferb;//预制体
    ...
    void Start()
    {
        AliceController.jumpForce=6.2f;
    ...
    void BarrierController(int t) //控制障碍物的生成
    {
        ...
        else
        {
            ...
            if (isMushRoomAppear1(t) && barrier==null) barrier = Instantiate(mushRoomPreferb1, transform.position + new Vector3(20.0f, -0.5f, 0), Quaternion.identity); //生成蘑菇墙
            if (isMushRoomAppear2(t) && barrier3==null) barrier3 = Instantiate(mushRoomPreferb2, transform.position + new Vector3(20.0f, -0.5f, 0), Quaternion.identity); //生成蘑菇墙
            if(isSmallMushRoomAppear(t) && barrier2 == null) barrier2 = Instantiate(smallMashroomPreferb, transform.position + new Vector3(20.0f, -0.95f, 0), Quaternion.identity); //生成小蘑菇墙
